  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-3 gap-2">
          {difficulties.map((d) => (
            <button
              ...
              className={`rounded-xl py-3 font-bengali text-lg font-bold border transition-all ${
                selected === d
      ...
      <motion.button
        ...
        className="w-full rounded-xl bg-gradient-to-r from-zen-500 to-zen-600 py-4 font-display text-lg font-bold text-white shadow-lg shadow-teal-900/40 hover:shadow-teal-700/50 transition-shadow animate-pulse-glow"
      >
        শুরু করুন — Start
      </motion.button>
    </motion.div>
