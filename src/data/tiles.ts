...
export const TILE_TYPES: TileTypeDef[] = [
  { char: 'অ', emoji: '🍓', gradient: 'from-rose-400 to-rose-600', glow: 'shadow-rose-500/40' },
  { char: 'আ', emoji: '🫐', gradient: 'from-sky-400 to-sky-600', glow: 'shadow-sky-500/40' },
  { char: 'ই', emoji: '🍏', gradient: 'from-emerald-400 to-emerald-600', glow: 'shadow-emerald-500/40' },
  { char: 'ঈ', emoji: '🍋', gradient: 'from-amber-400 to-amber-600', glow: 'shadow-amber-500/40' },
  { char: 'উ', emoji: '🍊', gradient: 'from-orange-400 to-orange-600', glow: 'shadow-orange-500/40' },
  { char: 'ঊ', emoji: '🍑', gradient: 'from-pink-400 to-pink-600', glow: 'shadow-pink-500/40' },
];

let nextId = 1;
function makeTile(type?: number): Tile {
  return { id: nextId++, type: type ?? Math.floor(Math.random() * TILE_TYPE_COUNT) };
}
